...
def crear_tabla_seguimiento_semanal(df_categoria):
    ...
    def get_accion_sugerida(estado_emoji, objetivo_tipo):
        ...
        acciones = {
            ('🔴 Riesgo', 'aumento'): "Aumentar proteína 20g/día. Reunión nutricional urgente.",
            ('🔴 Riesgo', 'disminución'): "Revisar déficit calórico. Aumentar cardio. Auditoría dietética.",
            ('🟡 Monitoreo', 'aumento'): "Progreso lento. Incrementar carbos post-entreno.",
            ('🟡 Monitoreo', 'disminución'): "En camino a meta. Continuar protocolo actual.",
            ('🟢 En Meta', 'aumento'): "Excelente. Mantener plan. Revisar en 10 días.",
            ('🟢 En Meta', 'disminución'): "Meta alcanzada. Transicionar a mantenimiento.",
            ('🟢 En Meta', 'mantenimiento'): "Estable. Mantener protocolo actual."
        }
...
def mostrar_tabla_seguimiento_profesional(df_seguimiento):
    ...
    with col1:
        rojos = len(df_seguimiento[df_seguimiento['Estado'].str.contains('🔴')])
        st.metric(
            "🔴 Riesgo",
            rojos,
    ...
    with col2:
        amarillos = len(df_seguimiento[df_seguimiento['Estado'].str.contains('🟡')])
        st.metric(
            "🟡 Monitoreo",
            amarillos,
    ...
    with col3:
        verdes = len(df_seguimiento[df_seguimiento['Estado'].str.contains('🟢')])
        st.metric(
            "🟢 En Meta",
            verdes,
